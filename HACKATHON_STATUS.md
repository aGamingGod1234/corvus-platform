...
- Python: `635 passed` in 67.42 seconds using an isolated final temp root; the expanded M2A authority/runtime suite passed `363` tests in 6.67 seconds; repository Ruff check/format and strict mypy passed for the changed sources.
