...
- Python: `670 passed` in 66.14 seconds in an isolated clean-room temporary directory; the dedicated security unit module passed `4` tests; full Ruff, Ruff format, and strict mypy passed.
