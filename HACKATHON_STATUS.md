...
- Python: `607 passed` in 70.63 seconds using an isolated final temp root; the expanded M2A authority/runtime suite passed `335` tests in 7.15 seconds; repository Ruff check/format and strict mypy passed for the changed sources.
