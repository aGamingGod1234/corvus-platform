...
const preview = { candidate, name: "review-pr", description: "Review a pull request", digest: "b".repeat(64), compatibility: "needs_review", findings: [{ code: "unapproved_tools", severity: "review", location: "SKILL.md", message: "Requested tools require approval." }], files: ["SKILL.md"], duplicate: "none" } as SkillImportPreview;
